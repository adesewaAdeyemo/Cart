...
<body>
    <div class="user">
        ...
        Email: <input type="email" name="email" value="" class='userEmail' required><br>
        Password<input type="password" name="password" value="" class='userPassword' required><br/>
        <a href='' class='forget'>Forgot password</a><br>
        <hr>
        <div class="log">
        <div><input type="checkbox">Remember me</div>
        <div><input type="submit" name="login" value="Log in" class="logend"></div>
        </div>
        ...
        if (isset($_POST["login"])){
            $_SESSION["email"] = isset($_POST["email"]) ? $_POST["email"] : "Email is empty";
